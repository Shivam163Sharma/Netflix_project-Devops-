...
<body>
    ...
    <div class="alert alert-secondary" role="alert">
        <h4 class="text-center">UPLOAD MOVIES</h4>
    </div>
    <div class="container col-12 m-5">
      ...
      if(isset($_POST['btn_img']))
      {
        ...
        ?>
         ...
         <form action="admin.php" method="post" class="form-control" enctype="multipart/form-data">
            <input type="file" class="form-control" name="choosefile"  id="">
            <div class="col-6 m-auto ">
                <button type="submit" name="btn_img" class="btn btn-outline-success m-4">
                Submit
            </button>
            <button type="home" name="btn_home" class="btn btn-outline-success m-4">
                Go To Homepage
            </button>
            <?php
